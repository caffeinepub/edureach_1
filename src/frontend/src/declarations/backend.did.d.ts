...
export type CourseCategory = { 'govExam' : null } |
  { 'singing' : null } |
  { 'computer' : null } |
  { 'english' : null };
export type CourseMode = { 'hybrid' : null } |
  { 'offline' : null } |
  { 'online' : null };
export interface DurationOption { 'feeInr' : bigint, 'months' : bigint }
...
export interface _SERVICE {
  ...
  'deleteEnrollment' : ActorMethod<[string], undefined>,
  'enroll' : ActorMethod<[Enrollment], undefined>,
  ...
  'getEnrollment' : ActorMethod<[string], Enrollment>,
  ...
  'updateEnrollment' : ActorMethod<[Enrollment], undefined>,
}
