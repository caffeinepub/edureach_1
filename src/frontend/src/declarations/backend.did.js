...
export const DurationOption = IDL.Record({
  'feeInr' : IDL.Nat,
  'months' : IDL.Nat,
});
...
export const Course = IDL.Record({
  'id' : IDL.Text,
  'title' : IDL.Text,
  'durationOptions' : IDL.Vec(DurationOption),
  'mode' : CourseMode,
...
export const idlService = IDL.Service({
  ...
  'deleteEnrollment' : IDL.Func([IDL.Text], [], []),
  'enroll' : IDL.Func([Enrollment], [], []),
  ...
  'getEnrollment' : IDL.Func([IDL.Text], [Enrollment], ['query']),
  ...
  'updateEnrollment' : IDL.Func([Enrollment], [], []),
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const DurationOption = IDL.Record({ 'feeInr' : IDL.Nat, 'months' : IDL.Nat });
